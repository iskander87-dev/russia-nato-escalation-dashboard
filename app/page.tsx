...
const indicators: Indicator[] = [
  ...
  {id:8,name:'Усиление ПВО, наблюдения и готовности НАТО',area:'Авиация и ПВО',status:'Подтверждено',date:'17.09.2026',source:'latvia',note:'Латвия объявила о прибытии в конце сентября четырёх немецких Eurofighter для временного усиления охраны воздушного пространства; Италия и Турция также внесут вклад. Это оборонительная мера НАТО, не признак российского развёртывания.',changed:true},
