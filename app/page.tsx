...
const indicators: Indicator[] = [
  ...
  {id:15,name:'Диверсионные операции на территории Альянса',area:'Гибридные операции',status:'Подтверждено',date:'02.09.2026',source:'leipzig',note:'Правительство Германии заявило, что Россия несёт ответственность за гибридную атаку на аэропорт Лейпциг/Галле; это подтверждает конкретный эпизод, а не все сообщения о диверсиях.',changed:true},
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero">
      ...
      <article className="trend"><p className="eyebrow">Динамика и журнал</p><div className="trend-value"><ArrowUpRight/> Умеренное повышение <small>внутри уровня 3</small></div><div className="events"><span><b>12.02</b> Балтийская безопасность</span><span><b>28.05</b> Усиление фланга</span><span className="now"><b>02.09</b> Атрибуция Лейпцига</span></div><p className="trend-note">Предыдущая оценка: 3,3 <b>↑ +0,3</b></p></article>
    </section>
