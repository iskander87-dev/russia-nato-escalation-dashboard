...
const sources = {
  ...
  denmark: { label:'ВС Дании: flares у вертолёта Fennec', date:'14.09.2026', url:'https://www.forsvaret.dk/da/nyheder/2026/forsvarets-helikopter-beskudt-med-flares-fra-russisk-fregat/' },
...
const indicators: Indicator[] = [
  ...
  {id:8,name:'Усиление ПВО, наблюдения и готовности НАТО',area:'Авиация и ПВО',status:'Подтверждено',date:'10.09.2026',source:'berlin',note:'НАТО подтверждает продолжение Eastern Sentry и усиление сдерживания и обороны на восточном фланге.',changed:true},
  ...
  {id:11,name:'Активность Балтийского и Северного флотов',area:'Море',status:'Подтверждено',date:'14.09.2026',source:'denmark',note:'Российский фрегат находился в международных водах у Дании и взаимодействовал с датским военным вертолётом.',changed:true},
  {id:12,name:'Опасные морские манёвры или повреждение инфраструктуры',area:'Море',status:'Подтверждено',date:'14.09.2026',source:'denmark',note:'Российский фрегат выпустил две flares в направлении Fennec; одна прошла на небольшом расстоянии от вертолёта.',changed:true},
...
export default function Home() {
  ...
  return <main>
    ...
    <section className="factors"><article className="rise"><h3><AlertTriangle/> Что повышает оценку</h3><ul><li>Российский фрегат выпустил две flares в направлении датского военного вертолёта.</li><li>Истребители миссии НАТО нейтрализовали БПЛА со взрывным устройством над Литвой.</li><li>Два подтверждённых военно-оперативных эпизода пересекли порог уровня 4.</li></ul></article><article className="restraint"><h3><ShieldCheck/> Что удерживает уровень ниже 5</h3><ul><li>Принадлежность и намерение сбитого БПЛА официально ещё расследуются.</li><li>Нет подтверждённой крупной ударной группировки и обеспечивающей логистики у границ НАТО.</li><li>Нет публично подтверждённого качественного скачка ядерной готовности.</li></ul></article></section>
    ...
    <section className="sources"><div><p className="eyebrow">Журнал проверок</p><h2>Ключевые события</h2></div><div className="source-list"><div><time>15.09.2026</time><p>Итальянские Eurofighter миссии НАТО нейтрализовали БПЛА, нарушивший воздушное пространство Литвы.</p><Source id="italy"/></div><div><time>14.09.2026</time><p>Российский фрегат выпустил две flares в направлении датского Fennec; одна прошла рядом с вертолётом.</p><Source id="denmark"/></div><div><time>18.09.2026</time><p>МИД Литвы подтвердил наличие взрывного устройства и продолжающееся расследование происхождения и цели БПЛА.</p><Source id="lithuania"/></div></div></section>
